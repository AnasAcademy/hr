                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <h2
                                                                            style="text-align:center; color: #000000; line-height:32px">
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0; text-align: center;">
                                                                            {{ __('Hi ') }} {{ $user->name }},
                                                                            {{ __(' Thank you for joining to ') . env('APP_NAME') . ' as a ' . $user->type }}
                                                                        </p>
                                                                        <p style="margin: 10px 0; text-align: center;">
                                                                            {{ __('To login your account detail, simply click on the button below:') }}
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td align="center" vertical-align="middle"
                                                                    ...
                                                                    <table border="0" cellpadding="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" bgcolor="#6676EF"
                                                                                role="presentation"
                                                                                style="border:none;border-radius:100px;cursor:auto;padding:15px 25px 15px 25px;background:#6676EF;"
                                                                                valign="middle">
                                                                                <a href="{{ route('login') }}"
                                                                                    style="background:#6676EF;color:#ffffff;font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;"
                                                                                    target="_blank">
                                                                                    <b style="font-weight:700"><b
                                                                                            style="font-weight:700">{{ __('Login') }}</b></b>
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                        <p style="margin: 10px 0; text-align: center;">
                                                                            {{ __('If the link doesn’t work, copy this URL into your browser') }}:
                                                                            {{ route('login') }} </p>
                                                                        <p style="margin: 10px 0; text-align: center;">
                                                                            <i style="font-style:normal"><b
                                                                                    style="font-weight:700">{{ __('Thank you for join to our team as a ' . $user->type) }}</b></i>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                            ...
                            <td class="img d" style="text-align: right;padding-top: 10px; float: right;"
                                width="50%"><a href="https://twitter.com/anasacademy?lang=ar" target="_blank"
                                    ...
                                    style="color: #4e54cb; text-decoration: none;"><img
                                        ...
                                        style="-ms-interpolation-mode: bicubic; max-width: 40px; margin: 0 5px !important;"
                                        border="0" alt=""></a><a
                                    href="https://www.youtube.com/channel/UCglrBLCkL6YnRZYy69-TwUw" target="_blank"
                                    style="color: #4e54cb; text-decoration: none;"><img
