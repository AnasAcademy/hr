    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="date" id="start_date" name="start_date" min="{{date('Y-m-d')}}" class="form-control  current_date">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="date" id="end_date" name="end_date" min="{{date('Y-m-d')}}" class="form-control  current_date">
