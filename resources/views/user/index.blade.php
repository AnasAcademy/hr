...
@section('page-title')
    @if (\Auth::user()->type == 'super admin')
        @if (Request::segment(1) == 'superAdmins')
            {{ __('Manage Super Admins') }}
        @else
            {{ __('Manage Companies') }}
        @endif
    @else
        ...
        @if (\Auth::user()->type == 'super admin')
            @if (Request::segment(1) == 'superAdmins')
                <a href="#" data-url="{{ route('user.create') }}" data-ajax-popup="true"
                    data-title="{{ __('Create New Admin') }}" data-size="md" data-bs-toggle="tooltip" title=""
                ...
                @if (Request::segment(1) == 'superAdmins')
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <a href="#" class="btn-addnew-project " data-ajax-popup="true"
                            data-url="{{ route('user.create') }}" data-title="{{ __('Create New Admin') }}"
                            data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                            data-bs-original-title="{{ __('Create') }}">
                            <div class="bg-primary proj-add-icon my-4">
                                <i class="ti ti-plus"></i>
                            </div>
                            <h6 class="mt-4 mb-2">{{ __('New Admin') }}</h6>
                            <p class="text-muted text-center">{{ __('Click here to add new Admin') }}</p>
                        </a>
                    </div>
                @else
                    @foreach ($users as $user)
                                            ...
                                            <div class=" p-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 text-center Id ">
                                                        <a href="#"
                                                            data-url="{{ route('company.info', $user->id) }}"
