                    ...
                    <table class="table" id="pc-dt-simple">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $promotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'company')): ?>
                                        <td><?php echo e(!empty($promotion->employee_id) ? $promotion->employee->name : ''); ?></td>
                                    <?php endif; ?>
                                    <td><?php echo e(!empty($promotion->designation_id) ? $promotion->designation->name : ''); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\OneDrive - اكاديمية انس للفنون البصرية\Desktop\hr\resources\views/promotion/index.blade.php ENDPATH**/ ?>