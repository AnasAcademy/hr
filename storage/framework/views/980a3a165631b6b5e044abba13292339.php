<?php $__env->startSection('page-title'); ?>
    <?php if(\Auth::user()->type == 'super admin'): ?>
        <?php if(Request::segment(1) == 'superAdmins'): ?>
            <?php echo e(__('Manage Super Admins')); ?>
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <?php if(\Auth::user()->type == 'super admin'): ?>
        <?php if(Request::segment(1) == 'superAdmins'): ?>
            <li class="breadcrumb-item"><?php echo e(__('Super Admins')); ?></li>
        <?php else: ?>
        ...
        <?php if(\Auth::user()->type == 'super admin'): ?>
            <?php if(Request::segment(1) == 'superAdmins'): ?>
                <a href="#" data-url="<?php echo e(route('user.create')); ?>" data-ajax-popup="true"
                    data-title="<?php echo e(__('Create New Admin')); ?>" data-size="md" data-bs-toggle="tooltip" title=""
                ...
                <?php if(Request::segment(1) == 'superAdmins'): ?>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <a href="#" class="btn-addnew-project " data-ajax-popup="true"
                            data-url="<?php echo e(route('user.create')); ?>" data-title="<?php echo e(__('Create New Admin')); ?>"
                            data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                            data-bs-original-title="<?php echo e(__('Create')); ?>">
                            <div class="bg-primary proj-add-icon my-4">
                                <i class="ti ti-plus"></i>
                            </div>
                            <h6 class="mt-4 mb-2"><?php echo e(__('New Admin')); ?></h6>
                            <p class="text-muted text-center"><?php echo e(__('Click here to add new Admin')); ?></p>
                        </a>
                    </div>
                <?php else: ?>
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class=" p-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 text-center Id ">
                                                        <a href="#"
                                                            data-url="<?php echo e(route('company.info', $user->id)); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\OneDrive - اكاديمية انس للفنون البصرية\Desktop\hr\resources\views/user/index.blade.php ENDPATH**/ ?>