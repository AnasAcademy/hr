...
<?php $__env->startSection('action-button'); ?>
    ...
    <?php if(\Auth::user()->type != 'employee'): ?>
        <a href="#" data-url="<?php echo e(route('holidays.file.import')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Import Holiday CSV file')); ?>" data-bs-toggle="tooltip" title=""
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto mt-4">
                                        ...
                                        <a href="<?php echo e(route('holiday.index')); ?>" class="btn btn-sm btn-danger"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\emem\Work\Anas Academy\hr\resources\views/holiday/index.blade.php ENDPATH**/ ?>