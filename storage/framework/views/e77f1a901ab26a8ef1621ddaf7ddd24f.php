        ...
        <?php if(\Auth::user()->type == 'employee' || \Auth::user()->type == 'manager' || \Auth::user()->type == 'hr'): ?>
            ...
            <div class="d-flex justify-content-end mb-5">
                <form action="create/ip" method="post" id="deviceIpIdentifier">
                    ...
                    ?>
                    <?php if(isset($_COOKIE['add_device_disabled'])): ?>
                        <?php
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\emem\Work\Anas Academy\hr\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>